...
const latestWindowSeconds = parseInt(process.env.RATE_LIMIT_WINDOW_S ?? '10', 10)
 ...
 */
const generateRequests = parseInt(process.env.GENERATE_RATE_LIMIT_REQUESTS ?? '3', 10)
const generateWindowHours = parseInt(process.env.GENERATE_RATE_LIMIT_WINDOW_H ?? '24', 10)
